<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php include template("content","head"); ?>
        <div class="banner w1200">
            <div class="banner-img fix">
                ...
                <div class="bd">
                    <ul>
                        <li><a><img src="images/banner.jpg" /></a></li>
                        <li><a><img src="images/banner.jpg" /></a></li>
                        <li><a><img src="images/banner.jpg" /></a></li>
                        <li><a><img src="images/banner.jpg" /></a></li>
                        <li><a><img src="images/banner.jpg" /></a></li>
        ...
        <div class="w1200">
            <div class="bd">
                <ul>
                    ...
                    <li><a href="news.html">重要通知：电子皮带秤是一种动态计量设备，它的精度与许多因素有关...</a></li>
                    <li><a href="news.html">重要通知：现在，鹿光的脚步不止于此。遵循“至繁归于至简”的核心理念...</a></li>
                    <li><a href="news.html">重要通知：电子皮带秤是一种动态计量设备，它的精度与许多因素有关...</a></li>
                    <li><a href="news.html">重要通知：现在，鹿光的脚步不止于此。遵循“至繁归于至简”的核心理念...</a></li>
                    <li><a href="news.html">重要通知：电子皮带秤是一种动态计量设备，它的精度与许多因素有关...</a></li>
            ...
            <div class="w1200">
                ...
                <div class="index_freshBom w1200">
                    <div class="bd">
                        <ul class="fix">
                            <li>
                                <a href="productxq.html">
                                    <i><img src="images/index_newest.jpg"></i>
                                    <em>
                                        <img src="images/index_newest1.png">
                                        <span>查看详情</span>
                                    </em>
                                    <b><img src="images/index_newest.png"></b>
                                    <p>XK3190-C603</p>
                                </a>
                            </li>
                             <li>
    ...
    <div class="index_product w1200">
        ...
        <div class="index_productBom fix le">
            <div class="hd fix">
                <ul class="fix">
                    <li><span>称重基础零部件</span></li>
                    <li><span>工业衡器</span></li>
                    <li><span>系统产品</span></li>
                    <li><span>软件产品</span></li>         
                </ul>
            </div>
            <div class="bd fix">
                <ul class="fix">
                   <li class="one">
                       <a href="productxq.html">
                            ...
                            <h3>电子汽车衡</h3>
                            <p>本公司的模块化电子汽车衡整体美观大方、结构合理、安装检修方便快捷。系统计量性能...
                            </p>
                       </a>
                   </li>
                   <li>
                ...
                <div class="index_newsBom">
                    ...
                    <div class="bd">
                        <ul>
                            <li class="one">
                                <a href="news.html">
                                    <b><img src="images/index_news1.jpg"></b>
                                    <em>
                                        <span>
                                            汽车衡称重常见作弊手段和...
                                            <strong></strong>
                                        ...
                                        <p>
                                            电子皮带秤是一种动态计量设备，它的精度与许多因素有关，一台电子皮带秤使用的好坏，不仅取决于秤的本身质量，而且还取决于安装位置。
                                        </p>
                                        <i>2018-7-23   14:22</i>
                                    </em>
                                </a>
                    ...
                    <a href="productxq.html" class="more">查看更多  +</a>
                </div>
                <script>
        ...
        <div class="index_contact">
            <div class="w1200">
                ...
                <div class="index_contactBom fix">
                    <div class="index_contactBom_left">
                        <img src="images/index_content_dt.jpg">
                    </div>
                    <div class="index_contentBom_right">
                        <ul>
                            ...
                            <li class="li2">
                                <em class="fix">
                                    <span>电话：</span>
                                    <p>0311-82100713、0311-82011949、400-0715-758</p>
                                </em>
                            </li>
                            <li class="li3">
                                <em class="fix">
                                    <span>邮箱：</span>
                                    <p>luguanghengqi@163.com787964631@qq.com</p>
                                </em>
                            </li>
                            <li class="li4">
                                <em class="fix">
        ...
        <div class="w1200">
            <div class="footer_top fix">
                ...
                <div class="footer_right">
                    <em>
                        <img src="images/footer_gzh.jpg">
                        <p>微信公众号</p>
                    </em>
                    <em>
                        <img src="images/footer_fwh.jpg">
                        <p>微信服务号</p>
                    </em>
                </div>
            </div>
            <div class="footer_bom">
                <p>版权所有：石家庄鹿光衡器有限公司    备案号：冀ICP备05077736号   网址：WWW.LUGUANGHENGQI.COM</p>
            </div>
        </div>
    </div>
    <div class="function">
        <i class="t"><a href="#anchor" class="topLink"><img src="images/top.png"></a></i>
        <div class="function_cn fix le">
            <div class="hd fix">
                <ul>
                    <li><img src="images/weix.png"></li>
                    <li><img src="images/qq.png"></li>
                    <li class="on"><img src="images/rex1.png"></li>        
                </ul>
            </div>
            <div class="bd fix">
                <ul>
                    <li>
                        <em><img src="images/ma.jpg"></em>
                    </li>
                </ul>
                <ul>
                    <li>
        ...
        <strong><a href=""><img src="images/liuyan.png"><p>预约咨询</p></a></strong>
        <script>
